...
+(instancetype)sharedInstance{
    static EWSAutodiscover* instnace = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instnace = [[EWSAutodiscover alloc] init];
    });
    return instnace;
}
...
-(void)autoDiscover:(NSString *)emailAddress resultBlock:(void(^)(NSString *ewsUrl, NSError *error))getEWSUrlBlock{
    ...
    EWSEmailBoxModel *ebInfo = ((EWSService *)[EWSService sharedInstance]).ewsEmailBoxModel;
